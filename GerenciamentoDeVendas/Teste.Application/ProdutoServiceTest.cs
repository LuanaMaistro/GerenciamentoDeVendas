...
namespace Teste.Application
{
    public class ProdutoServiceTest
    {
        ...
        public async Task CriarAsync_CodigoDuplicado_LancaInvalidOperationException()
        {
            ...
            var dto = new ProdutoCreateDTO("P001", "Produto", 10m, null, null);
        ...
        public async Task CriarAsync_DadosValidos_CriaERetornaDTO()
        {
            ...
            var dto = new ProdutoCreateDTO("P001", "Notebook", 2500m, "Descrição", "Eletrônicos");
        ...
        public async Task CriarAsync_FalhaRecombee_NaoBloqueiaCriacao()
        {
            ...
            var dto = new ProdutoCreateDTO("P001", "Notebook", 2500m, null, null);
        ...
        public async Task AtualizarAsync_ProdutoNaoEncontrado_LancaInvalidOperationException()
        {
            ...
            var dto = new ProdutoUpdateDTO("Novo Nome", null, 10m, null);
        ...
        public async Task AtualizarAsync_DadosValidos_AtualizaERetornaDTO()
        {
            ...
            var dto = new ProdutoUpdateDTO("Notebook Pro", "Nova desc", 3000m, "Eletrônicos");
